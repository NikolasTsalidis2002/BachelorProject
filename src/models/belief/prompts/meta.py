...
###### PERCEIVE ########
PERCEPTION={
     "self": """Here is your current beliefs and thoughts: {state}.""",
...
###### UPDATE ########
UPDATE="""Reflect upon this context, to see if and how {name} has evolved its thoughts and beliefs.
...
TRANSMIT_spe="""Reflect upon this context, and decide what {name} should share with {name}2. 
