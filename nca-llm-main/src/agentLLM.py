...
from src.agent import GridAgent, NetAgent, Agent
...
class LLMAgent:
    ...
    def __init__(self, config, state=None, message=None, persona="", name=None, extra_prompt=""):
        """
        LLM Agent
    ...
    def initialise_llm(self, model_name):
        ...
        if "llama" in model_name:  # context length from config file
...
class GridLLMAgent(LLMAgent):
    ...
    def __init__(self, config, position=None, state=None, message=None, persona="", extra_prompt=""):
        """
        ...
        LLMAgent.__init__(self, config, state=state, persona=persona, message=message, extra_prompt=extra_prompt)
...
class NetLLMAgent(LLMAgent):
    ...
    def __init__(self, config, network=None, state=None, message=None, persona="", extra_prompt=""):
        """
        LLM Agent for grid model
        """
        for key, val in config["parameters_llm"].items():
